...
- `agents/` - AI runners (Codex, OpenCode, Kilo, Claude, etc.) plus harnesses,
  tooling, and workflows
- `plans/` - Cross-project planning and meta-docs
- `bun-one/` - TypeScript/Bun consolidated workspace (in-progress)
- `deno-one/` - Deno consolidated workspace (in-progress)
- `experiments/` - Agent-agnostic experiment workspaces (see
