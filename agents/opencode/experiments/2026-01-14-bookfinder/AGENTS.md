...
- Adhere to global `../../AGENTS.md` rules.
...
**Crucial**: OpenCode MUST run `bun run fmt:md` and `bun run lint:md` on every
markdown file change. The CI pipeline will fail if these are not clean. You must
