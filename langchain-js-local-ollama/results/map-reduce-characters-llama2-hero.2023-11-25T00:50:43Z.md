...
- Level 0 output summary:
  - 213 docs, length: 72.64 kB
    Vin: has 77 descriptions
    Elend: has 55 descriptions
    Sazed: has 47 descriptions
    Spook: has 33 descriptions
    Ruin: has 30 descriptions
    Breeze: has 30 descriptions
    Kelsier: has 23 descriptions
    TenSoon: has 20 descriptions
    Quellion: has 17 descriptions
    Yomen: has 16 descriptions
    Marsh: has 15 descriptions
    Cett: has 15 descriptions
    Ham: has 14 descriptions
    Beldre: has 14 descriptions
    Allrianne: has 11 descriptions
