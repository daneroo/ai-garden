...
> [!NOTE]
> This section is a work in progress. We are currently gathering design
> decisions here as they emerge.

### Semantic Color Functions

DaisyUI provides palette slots; we define their grammar:

- Primary (`text-primary`): Identity & Action
- Secondary (`text-secondary`): Depth & Decoration
- Accent (`text-accent`): Interrupts & Status

### Typography Hierarchy

- **H2 (Section Anchors)**: `text-3xl font-bold text-primary`
  - Acts as a visual rhythm anchor while scrolling.
- **H3 (Sub-labels)**:
  `text-lg font-semibold text-base-content/70 uppercase tracking-widest`
  - Monochromatic to differentiate from content without adding color noise.
